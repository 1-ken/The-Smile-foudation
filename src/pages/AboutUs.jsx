        ...
        <div className='bg-white max-w-6xl mx-auto p-4 md:p-8'>
          ...
          <div className='flex justify-center mt-8'>
            <ul className='flex gap-6'>
              <li><img src={Founder} alt='founder' className='w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full shadow-lg' /></li>
              <li><img src={coFounder} alt='co-founder' className='w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full shadow-lg' /></li>
            </ul>
          </div>
          <div className='text-center mt-8'>
            <h1 className='text-lg md:text-xl lg:text-2xl xl:text-3xl text-[#FF0000] font-bold'>Group Photo</h1>
          </div>
        </div>
      </div>
    </main>
